> 来源：addyosmani/agent-skills v0.6.9 · `frontend-ui-engineering.md`（原样搬入，未本地改动）
...
For detailed accessibility requirements and testing tools, see `../_shared/references/accessibility-checklist.md`.
