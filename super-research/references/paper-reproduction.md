...
1. **Paper**: arXiv id / DOI / URL. Also: does an official reference implementation exist? (Search GitHub via tavily_extract before committing to reproduction-from-scratch — the user may only want you to run their code.)
