...
Designed as the `on_failure` substitute for AI video-generation steps: when
a moderated video model refuses a request, this script produces a valid
replacement clip from the still that already landed on disk, so a downstream
merge still yields a complete deliverable.
