---
name: tdd
description: "测试驱动开发：红→绿→重构，以行为测试驱动实现 Test-driven development with red-green-refactor loop. Use when user wants to build features or fix bugs using TDD, mentions 'red-green-refactor', wants integration tests, or asks for test-first development."
user-invocable: true
---
