> 来源：addyosmani/agent-skills v0.6.9 · `code-review-and-quality.md`（原样搬入，未本地改动）
...
- For detailed security review guidance, see `../_shared/references/security-checklist.md`
- For performance review checks, see `../_shared/references/performance-checklist.md`
