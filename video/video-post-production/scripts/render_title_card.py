...
Designed as the "cover" and "ending" PNG generators for a short-video
pipeline: deterministic, free, no API, CJK-friendly font fallback. The output
PNG can then be fed to animate.py to become a short MP4 clip.

Usage:
    python render_title_card.py --text "咖啡店偶遇" --output cover.png \\
...
_MEDIA_FONTS_DIR_ENV = "VIDEO_FONTS_DIR"
