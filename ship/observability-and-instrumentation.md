> 来源：addyosmani/agent-skills v0.6.9 · `observability-and-instrumentation.md`（原样搬入，未本地改动）
...
For the at-a-glance version of this list, including the pre-launch instrumentation gate, see `../_shared/references/observability-checklist.md`.
