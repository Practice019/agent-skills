> 来源：addyosmani/agent-skills v0.6.9 · `shipping-and-launch.md`（原样搬入，未本地改动）
...
- For the project-wide Definition of Done that every change must clear before this checklist, see `../_shared/references/definition-of-done.md`
- For security pre-launch checks, see `../_shared/references/security-checklist.md`
- For performance pre-launch checklist, see `../_shared/references/performance-checklist.md`
- For accessibility verification before launch, see `../_shared/references/accessibility-checklist.md`
